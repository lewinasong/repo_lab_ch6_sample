...
CREATE TABLE PGM_EXEC_PTCL (
                               HIST_ID BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT, -- SEQUENCE
                               EMP_NO VARCHAR(7) NOT NULL,
...
--INSERT INTO PGM_EXEC_PTCL (EMP_NO, PGM_ID, PGM_STR_DT, SCSS_YN, PGM_STR_DTM)
--VALUES ('1234567', '1', CURDATE(), 1, NOW());
--INSERT INTO PGM_EXEC_PTCL (EMP_NO, PGM_ID, PGM_STR_DT, SCSS_YN, PGM_STR_DTM)
--VALUES ('1234567', '2', CURDATE(), 1, NOW());
--INSERT INTO PGM_EXEC_PTCL (EMP_NO, PGM_ID, PGM_STR_DT, SCSS_YN, PGM_STR_DTM)
--VALUES ('1234567', '6', CURDATE(), 1, NOW());